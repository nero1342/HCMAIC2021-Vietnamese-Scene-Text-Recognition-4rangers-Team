...
def parse_args():
    ...
    parser.add_argument('det_input', help='Det folder.')
...
def main():
    ...
    print(os.getcwd())
    cfg.data.test.datasets[0].img_prefix = args.det_input
    cfg.data.test.datasets[0].ann_file = os.path.join(args.det_input, 'test_list.txt')
    print(cfg.data.test)
